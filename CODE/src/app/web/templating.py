...
# base.html necesita saber si hay sesión de cliente/staff para decidir qué nav
# mostrar (ver DEC-09) — expuestas como globals para no duplicar el string de
# la clave fuera de `security.py`, única fuente de verdad de esos nombres.
