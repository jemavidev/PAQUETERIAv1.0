...
"""Add missing MessageStatus values

Revision ID: 492767fdcdfb
Revises: a5d463fb8a42
Create Date: 2025-10-11 07:34:36.055471
...
revision = '492767fdcdfb'
down_revision = 'a5d463fb8a42'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('notifications', 'priority',
               ...
               type_=sa.Enum('BAJA', 'MEDIA', 'ALTA', 'URGENTE', name='notificationpriority'),
               nullable=False,
...
def downgrade() -> None:
    ...
    op.alter_column('notifications', 'recipient',
               ...
               existing_nullable=False)
    op.alter_column('notifications', 'priority',
               existing_type=sa.Enum('BAJA', 'MEDIA', 'ALTA', 'URGENTE', name='notificationpriority'),
               type_=sa.VARCHAR(length=20),
               nullable=True,
               existing_server_default=sa.text("'NORMAL'::character varying"))
    op.alter_column('notifications', 'event_type',
