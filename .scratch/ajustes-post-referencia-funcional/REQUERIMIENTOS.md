...
**Roadmap completo — 287/287 tests pasan.** LIWA implementado y desplegado con credenciales reales; verificación en vivo bloqueada por whitelist de IP pendiente del lado de LIWA (ver Grupo 8). Header/footer: tickets 01 y 02/3 implementados (nav pública + cliente), pendiente 03 (`.scratch/header-footer/`).
