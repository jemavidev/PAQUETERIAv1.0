...
**Roadmap completo — 287/287 tests pasan.** LIWA implementado y desplegado con credenciales reales; verificación en vivo bloqueada por whitelist de IP pendiente del lado de LIWA (ver Grupo 8). Header/footer: ticket 01/3 implementado (nav pública), pendientes 02/03 (`.scratch/header-footer/`).
