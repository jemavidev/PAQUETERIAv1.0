...
**Roadmap completo — 287/287 tests pasan.** LIWA implementado y desplegado con credenciales reales; verificación en vivo bloqueada por whitelist de IP pendiente del lado de LIWA (ver Grupo 8). Header/footer: spec publicado (`.scratch/header-footer/spec.md`), pendiente `/to-tickets` + `/implement`.
