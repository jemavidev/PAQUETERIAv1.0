...
- `350` — Info legal/cambiante (NIT, dirección, razón social, etc.) hoy hardcodeada en 4 plantillas distintas debería ser editable desde `/administracion/conjunto` y reflejarse en las páginas públicas (misma idea para tarifas, que ya tienen fuente de verdad real en `/administracion/tarifas-cobro`) — **pendiente, fuera de alcance del trabajo actual a propósito**
