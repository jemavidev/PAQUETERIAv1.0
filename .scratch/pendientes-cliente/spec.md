...
- `70` — `/residentes`: quitar "Zona de peligro" de la ficha por completo (ya existe en la lista) + formato compacto "T 05 - APT 105"/"No Asignado" en la columna Torre y Apartamento de la lista — **implementado** (fondo rojizo de Secundario y aviso de reasignación quedan abiertos, ver [[69]])
