...
- `295` — Revierte parte de [[190]]: "Notificaciones"/"Proveedores" dejan de duplicarse como tab visible en `.site-nav` (staff admin) -- quedan únicamente en el menú de cuenta (`.site-actions`) — **implementado**
