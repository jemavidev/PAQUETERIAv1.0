...
# -*- coding: utf-8 -*-
"""
PAQUETES EL CLUB v4.0 - Script de Limpieza via Endpoint
Versión: 1.0.0
Fecha: 2025-01-24
Autor: Equipo de Desarrollo

Este script ejecuta la limpieza de base de datos a través del endpoint de la aplicación.
"""
...
def cleanup_via_endpoint():
    ...
    print("🚀 PAQUETES EL CLUB v4.0 - Limpieza via Endpoint")
    print("="*60)
