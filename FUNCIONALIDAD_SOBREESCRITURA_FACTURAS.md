# ✅ Funcionalidad: Sobreescribir Facturas Existentes

## 🎯 Objetivo

Permitir actualizar facturas existentes al cargar nuevos PDFs, siempre y cuando **NO** estén en estado "Completo".
